...
func SaveCommentHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SaveCommentReq
		if err := httpx.Parse(r, &req); err != nil {
			httpc.RespError(r.Context(), w, r, err)
			return
		}
		l := comment.NewSaveCommentLogic(r.Context(), svcCtx)
		resp, err := l.SaveComment(&req)
		if err != nil {
			httpc.RespError(r.Context(), w, r, err)
		} else {
